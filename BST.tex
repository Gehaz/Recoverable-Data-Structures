	...
	\begin{code}
		\func{Recover}() \{ \nlc \n
			...
			if $op$ of type \IFlag\ then \{ \nlc \n
				...
				if $result = \langle \insertflag,op \rangle$ then \func{HelpInsert}$(op)$ \tabtabcom Finish the insertion \nlc
			...
			if $op$ of type \DFlag\ then \{ \nlc \n
				...
				if $result = \langle \deleteflag, op \rangle$ then \func{HelpDelete}$(op)$ \tabtabcom Either finish deletion or unflag \nlc
